...
class ChatWidget {
    ...
    async getWorkspaces() {
        const url = `${this.apibase}/api/anything/workspaces?UID=68c5ae71-e485-49ff-92c1-ddd29d4d12dc`;
        try {
    ...
    async sendMessage() {
        ...
        try {
            ...
            const response = await fetch(`${this.apibase}/api/anything/${this.workspace}/chat?UID=68c5ae71-e485-49ff-92c1-ddd29d4d12dc`, {
                method: 'POST',
                headers: {
    ...
    async sendExecute() {
        ...
        try {
            ...
            const response = await fetch(`${this.apibase}/api/openai/fc/deepseek-chat?UID=68c5ae71-e485-49ff-92c1-ddd29d4d12dc`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-User-Name': threadSlug // 添加thread slug到请求头
    ...
    executeFunction(functionCall) {
        ...
        xhr.open("POST", `${this.apibase}/api/functions/execute?UID=68c5ae71-e485-49ff-92c1-ddd29d4d12dc`, false); // false表示同步请求
    ...
    async sendReport() {
        ...
        try {
            ...
            const response = await fetch(`${this.apibase}/api/openai/chat/deepseek-chat?UID=68c5ae71-e485-49ff-92c1-ddd29d4d12dc`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-User-Name': threadSlug // 添加thread slug到请求头
